...
def test_invalid_source(bad_source):
    with pytest.raises(TypeError):
        list(woosh.tokenize(bad_source))


def test_invalid_source_no_tell():
    class InvalidSource:
...
def test_invalid_source_bad_tell(error):
    class InvalidSource:
        def tell(self):
            raise error
        def readline(self, size=-1):
...
def test_invalid_source_no_readline():
    class InvalidSource:
        def tell(self):
            return 0 
        def seek(self, value):
...
def test_invalid_source_bad_readline(error):
    class InvalidSource:
        def tell(self):
            return 0
        def readline(self, size=-1):
...
def test_invalid_source_invalid_readline(invalid):
    class InvalidSource:
        def tell(self):
            return 0
        def readline(self, size=-1):
...
def test_invalid_source_weird_readline(weird):
    class InvalidSource:
        def __init__(self):
            self.q = [b'123', weird]
        def tell(self):
...
def test_invalid_source_no_seek():
    class InvalidSource:
        def tell(self):
            return 0 
        def readline(self, size=-1):
...
def test_invalid_source_bad_seek(error):
    class InvalidSource:
        def tell(self):
            return 0
        def readline(self, size=-1):
